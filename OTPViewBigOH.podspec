...
Pod::Spec.new do |s|
  s.name             = 'OTPViewBigOH'
  s.version          = '0.1.0'
  s.summary          = 'A short description of OTPViewBigOH.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Mohammad Hammad/OTPViewBigOH'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Mohammad Hammad' => 'mohammad.hammad@bigohtech.com' }
  s.source           = { :git => 'https://github.com/Mohammad Hammad/OTPViewBigOH.git', :tag => s.version.to_s }
